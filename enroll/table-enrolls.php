                ...
                <table>
                    ...
                    if ($result->num_rows > 0) {
                        for ($i = 0; $i < $result->num_rows; $i++) {
                            ...
                            // tính năng Sửa 
                            echo  " <a href='change-enroll.php?id=" . $id . "' title ='Sửa'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
                        ...
                        echo "<tr><td colspan=4 text-align='center'>Bạn Chưa đăng ký khóa học</td></tr>";
                    }
                    ...
                    <div class="table-view">
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='7' text-align='center'>Bạn Chưa đăng ký khóa học</td></tr>";
                        }
                    } else {
                        echo  "<tr><td colspan='7' text-align='center'>Chưa có dữ liệu! Vui lòng Nhập để Hiện thị</td></tr>";
                    }
                    $conn->close();
                        ?>
                        </table>
